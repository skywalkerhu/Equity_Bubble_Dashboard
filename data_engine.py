...
def get_local_equity_issuance_data():
    """Reads the manually downloaded Quarterly_Net_Equity_Issuance.csv file from the local directory."""
    try:
        file_path = 'data/Quarterly_Net_Equity_Issuance.csv'
...
def process_data():
    ...
    # Fetch Equity Issuance via Local CSV
    efa_equity_df = get_local_equity_issuance_data()
    
    # Merge the two quarterly datasets
    macro_quarterly = macro_quarterly.join(efa_equity_df, how='outer')
